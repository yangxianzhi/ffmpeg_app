...
int main(int argc, char* argv[])
{
	...
	//char rtspUrl[] = "rtsp://admin:e529xmedia@10.10.100.55/Streaming/Channels/102";
	char rtspUrl[] = "rtsp://www.kfchain.com:554/E529A17010225_2";
...
// 					}
					...
					if (ret < 0) {
						printf("Decode Error11.\n");
						continue;
					}

					ret = avcodec_receive_frame(pCodecCtx, pFrame);
					if (ret < 0) {
						printf("Decode Error22.\n");
						continue;
					}
